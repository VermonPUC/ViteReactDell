...
export const Inicio = () => {
    return(
        <div className="flex flex-col items-center p-24 gap-y-24">
            <h1 className="text-5xl font-bold text-blue-600">Bem-vindo ao Mega-Sena Dell</h1>
            <p className="text-lg mt-4 font-bold">Cadestres as apostas e concorra a prêmios incríveis!</p>
